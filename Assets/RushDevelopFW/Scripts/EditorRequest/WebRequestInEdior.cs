...
namespace RDFW
{
    ...
    public class WebRequestInEdior : MonoBehaviour
    {
        ...
        private void InstallPackage(string packageUrl)
        {
            ...
            AssetDatabase_importPackageCompleted("r.d.Sim");
        }
        /// <summary>
        /// 安装package完成后，显示更新日志
        /// </summary>
        ...
        {
            EditorUtility.DisplayDialog(string.Format("R.D.FW{0}已是最新版本", RDUpdateConfig.CurVersionNum), RDUpdateConfig.log, "这就去尝试！");
        }
        ...
        private void CompareVersion(string dversion)
        {
            ...
            {   
                ...
                {
                    Debug.LogFormat( "R.D.版本管理器：您当前使用的是最新版本 {0}！如有问题请联系244215913@qq.com", oldVersion.versionNum);
