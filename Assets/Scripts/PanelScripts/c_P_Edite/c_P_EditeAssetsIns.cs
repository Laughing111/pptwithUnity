...
public partial class c_P_Edite : UIBase{
    ...
    private Transform trans_c_icon_mask;
    ...
    private Transform trans_c_GifWaite;
    partial void Search4Expeted()
    {
        ...
        trans_c_icon_mask=transform.SearchforChild("c_icon_mask");
        ...
        trans_c_GifWaite=transform.SearchforChild("c_GifWaite");
    }
}